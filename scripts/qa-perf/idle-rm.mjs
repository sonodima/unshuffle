// Idle CPU (renderer + GPU process) on Home / Lobby, visible vs hidden, WebGL vs CSS fallback.
...
const S = [
  ['lobby desktop reduced-motion (shader 30fps)', { screen: 'lobby', reduced: true }],
  ['lobby phone reduced-motion (shader 30fps)', { screen: 'lobby', device: 'phone', reduced: true }],
];const S_OLD = [
  ['home desktop webgl', {}],
  ['home desktop css-fallback', { webgl: false }],
  ['home desktop reduced-motion', { reduced: true }],
  ['home phone webgl', { device: 'phone' }],
  ['home desktop HIDDEN', { hidden: true }],
  ['lobby desktop webgl', { screen: 'lobby' }],
  ['lobby desktop css-fallback', { screen: 'lobby', webgl: false }],
  ['lobby phone webgl', { screen: 'lobby', device: 'phone' }],
  ['lobby desktop HIDDEN', { screen: 'lobby', hidden: true }],
]
