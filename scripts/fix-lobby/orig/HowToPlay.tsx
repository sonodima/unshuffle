...
import { Icon, Panel, cn, formatNumber, type IconName } from '../../components/ui'
...
function steps(s: Pick<GameSettings, 'snippets' | 'finalTimer'>): Step[] {
  return [
    {
      icon: 'headphones',
      title: 'Ascolta',
      body: `Ogni canzone è tagliata in ${s.snippets} spezzoni mescolati. Tocca un blocco per sentirlo.`,
      tone: 'var(--color-cyan)',
    },
    {
      icon: 'shuffle',
